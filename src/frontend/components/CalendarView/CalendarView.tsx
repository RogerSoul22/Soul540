          ...
          <>
            <div className={styles.panelBody}>
              ...
              <div className={styles.formRow}>
                ...
                <div className={styles.formField}>
                  <label className={styles.formLabel}>De 8 até 12 anos</label>
              ...
              <div className={styles.formRow}>
                <div className={styles.formField}>
                  <label className={styles.formLabel}>Garçom</label>
              ...
              <div className={styles.formRow}>
                <div className={styles.formField}>
                  <label className={styles.formLabel}>Funcionários no evento</label>
                ...
                <div className={styles.formField}>
                  <label className={styles.formLabel}>Equipe escalada (IDs separados por vírgula)</label>
              ...
              <div className={styles.formRow}>
                <div className={styles.formField}>
                  <label className={styles.formLabel}>Extras - louças (pessoas)</label>
              ...
              <div className={styles.formField}>
                <label className={styles.formLabel}>Cardápio (separado por vírgula)</label>
...
// ── Main component ────────────────────────────────────────────────────────────
export default function CalendarView({ events, month: controlledMonth, onMonthChange }: Props) {
  const { updateEvent, deleteEvent } = useApp();
  const [view, setView] = useState<ViewMode>('month');
  const [internalMonth, setInternalMonth] = useState(new Date());
  const currentMonth = controlledMonth ?? internalMonth;
  const setCurrentMonth = (m: Date | ((prev: Date) => Date)) => {
                  ...
                  <div className={styles.pills}>
                    {de.slice(0, 3).map((ev) => {
                      ...
                      return (
                        <div
                          key={ev.id}
                          className={[styles.pill, ev.notes?.trim() ? styles.pillNotes : ''].filter(Boolean).join(' ')}
                          style={{
                            background: c.bg,
                            color: c.text,
